                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <button 
                                            onClick={() => {
                                                ...
                                                if(min && !isNaN(parseInt(min))) setDailyTargetSeconds(parseInt(min) * 60);
                                            }}
                                            className="flex-1 py-2 rounded-xl text-xs font-bold transition-all border bg-slate-800 border-slate-700 text-slate-400 hover:bg-slate-700"
                                        >
                                            Custom
                                        </button>
                                    </div>
                  ...
                  <div className="bg-gradient-to-r from-pink-50 to-rose-50 p-4 rounded-2xl border border-pink-100 shadow-sm mt-4">
                      ...
                      <div>
                          ...
                          <div className="grid grid-cols-3 gap-3">
                              ...
                              <button onClick={() => onTabChange('INBOX')} className="h-16 w-full bg-white border border-slate-200 rounded-xl shadow-sm flex items-center justify-center gap-2 hover:scale-[1.02] transition-transform relative group">
      ...
      if (activeTab === 'INBOX') {
        return (
            <div className="animate-in fade-in slide-in-from-bottom-2 duration-300 pb-24">
                <div className="bg-white rounded-2xl w-full shadow-xl overflow-hidden border border-slate-200">
                    <div className="bg-slate-50 p-4 border-b border-slate-100 flex justify-between items-center">
                        ...
                        <button onClick={() => onTabChange('HOME')} className="text-slate-400 hover:text-slate-600"><X size={20} /></button>
                    </div>
